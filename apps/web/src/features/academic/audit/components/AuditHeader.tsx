    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
      <div style={{
        ...
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <span style={{
              ...
              <ShieldCheck size={14} /> Quality Assurance Gate
            </span>
          </div>
          <p style={{ margin: '6px 0 0 0', color: '#64748B', fontSize: '14px', maxWidth: '820px' }}>
            Monitor academic quality, curriculum compliance, teaching effectiveness, and institutional learning standards across all departments.
          </p>
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', flexWrap: 'wrap' }}>
          ...
          >
            <Calendar size={15} color="#3B7E5E" /> Schedule Audit
          </button>
          ...
          >
            <CheckSquare size={15} color="#3B82F6" /> Create Checklist
          </button>
