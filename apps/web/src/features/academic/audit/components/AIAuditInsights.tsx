...
import type { AIAuditInsight } from '../types';
import { Sparkles, AlertTriangle, ArrowRight } from 'lucide-react';

interface AIAuditInsightsProps {
  insights: AIAuditInsight[];
  onTakeAction: (insight: AIAuditInsight) => void;
}

export const AIAuditInsights: React.FC<AIAuditInsightsProps> = ({ insights, onTakeAction }) => {
  return (
    <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          ...
          <div>
            <h2 style={{ margin: 0, fontSize: '18px', fontWeight: 800, color: '#0F172A' }}>
              EduVerse AI Academic Quality & Curriculum Diagnostics
            </h2>
            <p style={{ margin: '2px 0 0 0', fontSize: '13px', color: '#64748B' }}>
              Machine learning diagnostics detecting department risk, syllabus delays, and exam paper blueprint compliance.
            </p>
          </div>
        </div>

        <div style={{ fontSize: '12px', fontWeight: 700, color: '#3B7E5E', background: '#EAF5F0', padding: '6px 14px', borderRadius: '20px' }}>
          3 Active AI Diagnostics
        </div>
      </div>
          ...
          >
            ...
            <div style={{
              ...
              <span style={{ fontSize: '11px', fontWeight: 600, color: '#334155' }}>
                AI Rec: {item.suggestedIntervention}
              </span>
              <button
