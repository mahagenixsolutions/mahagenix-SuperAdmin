...
import { dailyAttendanceTrendData, gradeAttendanceData } from '../mockData';
import { TrendingUp, BarChart2, Calendar } from 'lucide-react';

export const AttendanceTrendAnalytics: React.FC = () => {
  return (
    <div style={{
      background: 'white',
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          ...
          <div>
            <h2 style={{ margin: 0, fontSize: '18px', fontWeight: 800, color: '#0F172A' }}>
              Institutional Attendance Trend & Grade Analytics
            </h2>
            <p style={{ margin: '2px 0 0 0', fontSize: '13px', color: '#64748B' }}>
              Historical attendance curves, weekday variance patterns, and grade-wise comparison.
            </p>
          </div>
        </div>
        ...
        <div style={{ background: '#F8FAFC', border: '1px solid #E2E8F0', borderRadius: '12px', padding: '18px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
            <h4 style={{ margin: 0, fontSize: '14px', fontWeight: 800, color: '#0F172A', display: 'flex', alignItems: 'center', gap: '6px' }}>
              <TrendingUp size={16} color="#3B7E5E" /> Weekly Attendance Curve (%)
            </h4>
          </div>

          <div style={{ width: '100%', height: 200 }}>
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={dailyAttendanceTrendData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                <defs>
                  <linearGradient id="attRateColor" x1="0" y1="0" x2="0" y2="1">
                ...
                <Area type="monotone" dataKey="rate" stroke="#3B7E5E" strokeWidth={3} fillOpacity={1} fill="url(#attRateColor)" />
              </AreaChart>
            </ResponsiveContainer>
          </div>
        </div>

        {/* Chart 2: Grade-wise Comparison */}
        <div style={{ background: '#F8FAFC', border: '1px solid #E2E8F0', borderRadius: '12px', padding: '18px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
            <h4 style={{ margin: 0, fontSize: '14px', fontWeight: 800, color: '#0F172A', display: 'flex', alignItems: 'center', gap: '6px' }}>
              <BarChart2 size={16} color="#3B82F6" /> Grade-wise Attendance Comparison (%)
            </h4>
          </div>
          ...
          <div style={{ width: '100%', height: 200 }}>
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={gradeAttendanceData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                ...
                <Tooltip contentStyle={{ background: '#0F172A', border: 'none', borderRadius: '8px', color: 'white', fontSize: '12px' }} />
                <Bar dataKey="pct" fill="#3B7E5E" radius={[6, 6, 0, 0]} barSize={28} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </div>
