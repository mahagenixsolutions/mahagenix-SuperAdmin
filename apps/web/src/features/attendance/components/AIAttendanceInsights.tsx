...
import type { AIAttendanceInsight } from '../types';
import { Sparkles, AlertTriangle, ArrowRight } from 'lucide-react';

interface AIAttendanceInsightsProps {
  insights: AIAttendanceInsight[];
  onTakeAction: (insight: AIAttendanceInsight) => void;
}

export const AIAttendanceInsights: React.FC<AIAttendanceInsightsProps> = ({
  insights,
  onTakeAction
}) => {
  return (
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          ...
          <div>
            <h2 style={{ margin: 0, fontSize: '18px', fontWeight: 800, color: '#0F172A' }}>
              EduVerse AI Predictive Attendance Intelligence
            </h2>
            <p style={{ margin: '2px 0 0 0', fontSize: '13px', color: '#64748B' }}>
              Machine learning forecasting models predicting at-risk students, Friday absenteeism spikes, and teacher roll-call delays.
            </p>
          </div>
        </div>

        <div style={{ fontSize: '12px', fontWeight: 700, color: '#3B7E5E', background: '#EAF5F0', padding: '6px 14px', borderRadius: '20px' }}>
          Predicted Monthly Rate: 94.1%
        </div>
      </div>
          ...
          >
            ...
            <div style={{
              ...
              <span style={{ fontSize: '11px', fontWeight: 600, color: '#334155' }}>
                AI Intervention: {item.suggestedIntervention}
              </span>
              <button
