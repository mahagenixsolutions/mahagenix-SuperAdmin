...
import type { AIAssignmentInsight } from '../types';
import { 
  Sparkles, 
  AlertTriangle, 
  Clock, 
...
interface AIAssignmentInsightsProps {
  insights: AIAssignmentInsight[];
  onTakeAction: (insight: AIAssignmentInsight) => void;
}

export const AIAssignmentInsights: React.FC<AIAssignmentInsightsProps> = ({
  insights,
  onTakeAction
}) => {
  return (
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          ...
          <div>
            <h2 style={{ margin: 0, fontSize: '18px', fontWeight: 800, color: '#0F172A' }}>
              EduVerse AI Assignment Operations Diagnostics
            </h2>
            <p style={{ margin: '2px 0 0 0', fontSize: '13px', color: '#64748B' }}>
              Automated pattern analysis detecting marking backlogs, student turn-in drops, and assignment overload.
            </p>
          </div>
        </div>
