...
export const NAVIGATION_CONFIG: NavSection[] = [
  {
    ...
    items: [
      ...
      { to: '/system-states', icon: SettingsIcon, label: 'System States' },
    ],
  },
  {
    section: 'Administration',
    items: [
      { to: '/org/branches', icon: BuildingIcon, label: 'Organization', permission: PERMISSIONS.ORGANIZATION_VIEW },
      { to: '/principal/approvals', icon: UserIcon, label: 'Principal', permission: PERMISSIONS.REPORTS_VIEW },
      { to: '/finance', icon: ReportIcon, label: 'Finance', permission: PERMISSIONS.FEES_VIEW },
      { to: '/hr', icon: UserIcon, label: 'HR', permission: PERMISSIONS.HR_VIEW },
      { to: '/reception', icon: BuildingIcon, label: 'Reception', permission: PERMISSIONS.VISITOR_VIEW },
    ],
  },
  {
    ...
    items: [
      ...
      { to: '/hostel', icon: BuildingIcon, label: 'Hostel', permission: PERMISSIONS.HOSTEL_VIEW },
      { to: '/security', icon: BuildingIcon, label: 'Security', permission: PERMISSIONS.SECURITY_VIEW },
    ],
  },
  {
    ...
    items: [
      ...
      { to: '/notifications', icon: CommunicationIcon, label: 'Notifications' },
